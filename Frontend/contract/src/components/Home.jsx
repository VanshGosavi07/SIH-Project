...
function Home() {
  ...
  return (
    <div style={{ backgroundColor: "#E9EDC9", position: "relative", overflow: "hidden" }}>
      <Navbar />
      <ImageSlider />
      ...
      <div className="container mx-auto px-4 mx-135 ">
        <div className="flex justify-center my-8">
          <h1 className="text-4xl font-semibold text-center pt-12" style={{ fontFamily: "Arial, sans-serif" }}>
            Live Contracts
          </h1>
        </div>
        ...
        {visibleCards < contractData.length && (
          <div className="flex justify-center mt-4 pt-8 pb-8">
            <button onClick={loadMoreCards} className="bg-blue-500 text-white px-4 py-2 rounded">
              Load More
            </button>
          </div>
        )}
